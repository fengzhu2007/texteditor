...
protected:
    ...
    TokenKind extendedTokenKind(const CStyle::Token &token) const;
...
protected:
    ...
    void adjustIndent(const QList<CStyle::Token> &tokens, int lexerState, int *indentDepth) const override;
