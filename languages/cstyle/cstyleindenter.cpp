...
public:
    ...
    virtual QString name() override {return QString::fromUtf8("CStyle");}
                                ...
                                int /*cursorPositionInEditor*/)
{
    ...
    CStyle::CreatorCodeFormatter codeFormatter(tabSettings);
...
{
    CStyle::CreatorCodeFormatter codeFormatter;
...
{
    return new CStyle::Indenter(doc);
}
