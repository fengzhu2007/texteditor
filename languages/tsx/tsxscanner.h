...
public:
    ...
    enum {
        ...
        TernaryExpression = MultiLineComment<<16,
        TypenameExpression = MultiLineComment<<17,
        GenericExpression = MultiLineComment<<18,
...
private:
    ...
    int findDecorator(QList<Code::Token>& tokens,const QString& text,int index);
