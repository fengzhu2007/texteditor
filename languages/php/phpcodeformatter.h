...
public: // must be public to make Q_GADGET introspection work
    enum StateType {
        ...
        top_php, // root for php
        objectdefinition_or_php, // file starts with identifier

        multiline_comment_start,
        multiline_comment_cont,

        use_start, // after 'use'
        use_maybe_slash_or_version_or_as, // after string or identifier
        use_slash, //after \ ;
        use_maybe_as, // after version
        use_as,
        ...
        elseif_clause, // The else line of an if-else construct.
